 ...
 */
class Personal extends \CELiceoParaisoApp\CELiceoParaisoBundle\Entity\Personal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'codigo', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'nombre', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'apellidos', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'correo', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'area', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'comite', '' . "\0" . 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity\\Personal' . "\0" . 'codigoDepartamento');
        }
    ...
    public function addComite(\CELiceoParaisoApp\CELiceoParaisoBundle\Entity\Comite $comite)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addComite', array($comite));

        return parent::addComite($comite);
    }
    ...
    public function removeComite(\CELiceoParaisoApp\CELiceoParaisoBundle\Entity\Comite $comite)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeComite', array($comite));

        return parent::removeComite($comite);
    }
    ...
    public function getComite()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getComite', array());
    ...
    public function addCodigoDepartamento(\CELiceoParaisoApp\CELiceoParaisoBundle\Entity\Departamento $codigoDepartamento)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCodigoDepartamento', array($codigoDepartamento));

        return parent::addCodigoDepartamento($codigoDepartamento);
    }
    ...
    public function removeCodigoDepartamento(\CELiceoParaisoApp\CELiceoParaisoBundle\Entity\Departamento $codigoDepartamento)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCodigoDepartamento', array($codigoDepartamento));

        return parent::removeCodigoDepartamento($codigoDepartamento);
    }
