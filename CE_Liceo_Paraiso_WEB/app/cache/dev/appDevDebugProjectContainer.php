...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'ce_paraiso_bd', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity'))), 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('CELiceoParaisoBundle' => 'CELiceoParaisoApp\\CELiceoParaisoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_dc513d3dee1c25e930e23e848a33845a6b82e91abf386518656544aacf4bba07');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('ce.liceo.paraiso@gmail.com');
        $a->setPassword('paraiso.2016');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\CELiceoParaisoApp\\CELiceoParaisoBundle/Resources/views'), 'CELiceoParaiso');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CELiceoParaisoBundle' => 'CELiceoParaisoApp\\CELiceoParaisoBundle\\CELiceoParaisoBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'ce_paraiso_bd',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_host' => 'smtp.gmail.com',
            'mailer_transport' => 'gmail',
            'mailer_user' => 'ce.liceo.paraiso@gmail.com',
            'mailer_password' => 'paraiso.2016',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'ce.liceo.paraiso@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'paraiso.2016',
